...
<body>
	...
	<table id="customers">
		...
		<%
			StudentForm studentForm = AppDAO
					.getStudentByRollNumber((String) request.getSession().getAttribute("username"));
		%>
		<tr>
