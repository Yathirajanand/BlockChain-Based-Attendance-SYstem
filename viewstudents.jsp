...
<body>
		...
		<div id="header">
			...
			<div id="menubar">
				<ul id="menu">
					...
					<li class="hvr-sweep-to-bottom"><a href="addstudent.jsp">Add
							Student</a></li>
	...
	<table id="customers">
		<tr>
			...
			<th><font size="4"><b>RollNo</b></font></th>
		...
		%>
		<tr>
			<td><a href="./uploads/<%=studentForm.getPhoto()%>"
				target="_blank"><img src="./uploads/<%=studentForm.getPhoto()%>"
