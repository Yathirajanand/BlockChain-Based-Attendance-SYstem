	...
	<div id="main">
		<div id="header">
			...
			<div id="menubar">
				<ul id="menu">
					...
					<li class="hvr-sweep-to-bottom"><a href="addattendance.jsp">Attendance</a></li>
		...
		<div id="site_content">
			<div id="content">
				...
				%>
				<form action="viewfacultyattendance.jsp">
					<table id="customers">
						<tr>
						...
						<tr>
							...
							<td><select name="student">
									...
									%>
											<option value="<%=studentForm.getRno()%>"><%=studentForm.getRno()%></option>
									<%
										}
									%>
				...
				<%
					...
					if (sub != null && student!=null) {
						...
						String url = "viewfacultyattendance.jsp?percentage=" + percentage
								+ "&sub="+sub+"&rno="+student;
