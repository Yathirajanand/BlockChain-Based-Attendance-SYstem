...
public class StudentRegistrationServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(isMultipart) {
			...
			if(isUploaded)
			{
				response.sendRedirect("addstudent.jsp?status="+AppService.studentRegistration(studentForm));
			}
			else
			{
				response.sendRedirect("addstudent.jsp?status=going wrong while uploading file");
			}
	    }
	}
}
