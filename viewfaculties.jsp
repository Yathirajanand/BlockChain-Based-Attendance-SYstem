		...
		<div id="header">
			...
			<div id="menubar">
				<ul id="menu">
					...
					<li class="hvr-sweep-to-bottom"><a href="addfaculty.jsp">Add Faculty</a></li>
			...
			<div id="content">
				...
				<table id="customers">
					<tr>
						...
						<th><font size="4"><b>Subjects</b></font></th>
						<th><font size="4"><b>Email</b></font></th>
						<th><font size="4"><b>Phone</b></font></th>
						<th><font size="4"><b>Qualification</b></font></th>
					</tr>
				<%
					List<FacultyForm> FacultyForms=AppDAO.getFacultyList();
							
					Iterator<FacultyForm> it=FacultyForms.iterator();
							
					while(it.hasNext())
					{
						FacultyForm facultyForm=it.next();
						
						List<String> subjects=AppDAO.getSubjectsByFaculty(facultyForm.getEmail());
				...
				%>
						<tr>
							<td><font size="3"><%=facultyForm.getFirstName()%></font></td>
							<td><font size="3"><%=subject.substring(0,subject.length())%></font></td>
